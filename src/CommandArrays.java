public class CommandArrays {
    ...
    public static String[] LEVELS = {"beginner", "intermediate", "advanced"};
    public static String[] CONSTRAINT_KEYWORDS = {"using", "without"};
    public static String[] LANGUAGES = {"Python", "Java", "C++", "JavaScript"};
    public static String[] RESOURCES = {"with example", "with hints", "with diagram"};
}